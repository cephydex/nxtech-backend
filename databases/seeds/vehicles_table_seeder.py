...
class VehiclesTableSeeder(Seeder):
    def run(self):
        ...
        id = 'c0000000-0000-0001-0001-cb1000000000'
        last_id = self.getInitId(id)
        db_data = []
        for car in car_list:
            print("Detail", car.get("brand"), car.get("models"))
            db_data.append({
                "id": f'c0000000-0000-0001-0001-cb{last_id}',
                "brand": car.get("brand"),
                "models": json.dumps(car.get("models")),
            })
            last_id = (last_id + 1)
        
        Vehicle.bulk_create(db_data)
        # print("Final", db_data)
